    ...
    <div class="card__container">
        <section class="room__price">
            <div class="room__price__card">
                <h1>Xonalar va narxlar</h1>
                <p>Bizning har bir yorug ', yorug'lik suvli xonalarimiz qulay yashash uchun kerak bo'lishi mumkin
                    bo'lgan barcha narsalar bilan ta'minlangan. Va ha,
                    konfor bizning yagona maqsadimiz emas, biz shuningdek, yaxshi dizayn, zamonaviy mebel bilan
                    to'ldirilishini qadrlaymiz
                    Xonalarimizning dengiz manzarali derazalari va teraslaridan ko'rinadigan tabiat palitrasining boy
                    ohanglari bilan.</p>
            </div>
            <img src="{{ asset('img/birkishilikxona.jpg') }}" alt="">

            <a class="brom" href="{{ route('brom', 1) }}">Band qilish</a>
            <img src="{{ asset('img/ikkikishilikxona.jpg') }}" alt="">
            <a class="brom" href="{{ route('brom', 2) }}">Band qilish</a>
            <img src="{{ asset('img/ekoxona.jpg') }}" alt="">
            <a class="brom" href="{{ route('brom', 3) }}">Band qilish</a>
        </section>
